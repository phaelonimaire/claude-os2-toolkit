...
mouse drivers (`session-manager.md`, `vio-kbd-mou.md` §3.6/§4.5), which each independently
...
keyboard/mouse in `vio-kbd-mou.md` §3.6/§4.5). One correction recorded in the process: `screen01.asm`'s
