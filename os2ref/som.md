...
signatures — is written in **SOM IDL** (§6). The implementation — the method procedures — is
...
resolution (§4) uses it to index the method table. Method tokens for a class `C` are held in that
